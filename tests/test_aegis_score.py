...
class TestAegisScore:
    ...
    def test_level_categories(self):
        # RED
        red = calculate_aegis_score(0.1, 0.1, 1, 0.1)
        assert red["level"] == "RED"

        # GREEN
        green = calculate_aegis_score(1.0, 1.0, 10, 1.0)
    ...
    def test_claude_confidence_normalized(self):
        ...
        high = calculate_aegis_score(0.5, 0.5, 10, 0.5)
        low = calculate_aegis_score(0.5, 0.5, 1, 0.5)
